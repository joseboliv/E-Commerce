namespace IdentityService.Api.Helpers.Swagger
{
    ...
    {
        private const string UriString = "https://www.localhost.com";

        private const string UriString1 = "https://localhost.com/";
        ...
        private static OpenApiInfo CreateInfoForApiVersion(ApiVersionDescription description)
        {
            OpenApiInfo info = new OpenApiInfo
            {
                ...
                Contact = new OpenApiContact { Name = "Jose Bolivar", Email = "josebolivars@outlook.es" },
